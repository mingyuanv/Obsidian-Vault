...
# 备注(声明)：
![RK3568（linux学习）/rk3568芯片开发/linux外设驱动开发（未）/assets/第十期 热插拔/file-20250810171745867.png](嵌入式知识学习（通用扩展）/linux外设驱动开发（未）/第十期%20热插拔/assets/❌废弃：第十期%20热插拔/file-20250810171745867.png)
...
### 3 迅为的buildroot文件系统密码（rockchip或topeet）
