...
![RK3568（linux学习）/rk3568芯片开发/linux外设驱动开发（未）/assets/第二十三期 ADC/file-20250810171741867.png](嵌入式知识学习（通用扩展）/linux外设驱动开发（未）/第二十三期%20ADC/assets/第二十三期%20ADC/file-20250810171741867.png)
...
## ADC子系统框图
### 1 、框架图
![RK3568（linux学习）/rk3568芯片开发/linux外设驱动开发（未）/assets/第二十三期 ADC/file-20250810171742100.png](嵌入式知识学习（通用扩展）/linux外设驱动开发（未）/第二十三期%20ADC/assets/第二十三期%20ADC/file-20250810171742100.png)
