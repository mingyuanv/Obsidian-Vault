...
[[芯片开发学习/RK3568（linux学习）/小项目/基于rk3568的智能家居项目/基于rk3568完成智能家居项目#2.2 杂项设备的框架]]
[[芯片开发学习/RK3568（linux学习）/小项目/基于rk3568的智能家居项目/基于rk3568完成智能家居项目#2.3 字符设备的框架]]


## 1. 杂项设备的框架
[[嵌入式知识学习（通用扩展）/linux驱动入门/第二期 字符设备基础/注册杂项设备驱动.canvas|杂项设备驱动]]
...
## 2、字符设备的框架
[[嵌入式知识学习（通用扩展）/linux驱动入门/第二期 字符设备基础/注册字符设备驱动.canvas|字符设备驱动]]
