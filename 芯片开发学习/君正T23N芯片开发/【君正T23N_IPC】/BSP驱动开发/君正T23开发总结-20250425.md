...
### 1.安装 Toolchain
[[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 SDK安装及使用指南.pdf#page=6&selection=95,0,98,9&color=important|T23 SDK安装及使用指南, p.6]]
如何安装 Toolchain
...
[[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 SDK安装及使用指南.pdf#page=6&selection=149,0,182,1&color=note|T23 SDK安装及使用指南, p.6]]
...
[[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/USBCloner烧录工具指南V2.pdf#page=35&selection=48,0,55,1&color=yellow|USBCloner烧录工具指南V2, p.35]]
...
[[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/USBCloner烧录工具指南V2.pdf#page=34&selection=100,0,100,4&color=important|USBCloner烧录工具指南V2, p.34]]
烧录基本操作
...
[[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 SDK安装及使用指南.pdf#page=8&selection=44,0,46,4&color=important|T23 SDK安装及使用指南, p.8]]
...
### 1.编译流程
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=12&selection=42,0,47,2&color=important|T23 BSP开发参考V1.1, p.12]]
> > 3.1 Uboot 编译
> 
> 

> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 软件资源编译指南.pdf#page=7&selection=197,0,201,2&color=important|T23 软件资源编译指南, p.7]]
> 1.2 Uboot 编译
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 软件资源编译指南.pdf#page=5&selection=40,0,42,2&color=important|T23 软件资源编译指南, p.5]]
> > Uboot 配置
> 
> 
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=14&selection=265,0,269,2&color=important|T23 BSP开发参考V1.1, p.14]]
> > 3.2 Kernel 编译


> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 软件资源编译指南.pdf#page=10&selection=36,3,42,5&color=important|T23 软件资源编译指南, p.10]]
> >  编译流程 kernel 可单独编译
> 
> 
...
### 2.报错与解结
 [[芯片开发学习/君正T23N芯片开发/【君正T32N-PIKE开发板】/AI扩展/编译 Linux 内核时，系统找不到 `gcc`（主机编译器）]]
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=8&selection=37,0,40,8&color=important|T23 文件系统制作指南, p.8]]
> >  Squashfs 文件系统制作方法
> 
> 


> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=8&selection=100,0,113,32&color=note|T23 文件系统制作指南, p.8]]
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=9&selection=0,3,34,8&color=important|T23 文件系统制作指南, p.9]]
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=7&selection=52,0,54,6&color=important|T23 文件系统制作指南, p.7]]
> > 1.3.2 文件系统搭建
> 
> 
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 软件资源编译指南.pdf#page=15&selection=36,0,42,2&color=important|T23 软件资源编译指南, p.15]]
> > 5.1 SDK sample 编译
> 
> 
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=15&selection=155,0,161,2&color=important|T23 BSP开发参考V1.1, p.15]]
> > 3.3 Busybox 编译
> 
> 
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=5&selection=50,0,52,6&color=important|T23 文件系统制作指南, p.5]]
> > 1.1 配置文件介绍
> 
> 
...
> [!PDF|yellow] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=5&selection=109,0,113,4&color=yellow|T23 文件系统制作指南, p.5]]
> > 1.2.1 配置 flag
> 
> 
...
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=6&selection=52,0,56,4&color=note|T23 文件系统制作指南, p.6]]
> > (1) uclibc 工具编译
> 
> 
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=18&selection=180,0,186,4&color=important|T23 BSP开发参考V1.1, p.18]]
...
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 文件系统制作指南.pdf#page=7&selection=53,1,54,6&color=note|T23 文件系统制作指南, p.7]]
> > 文件系统搭建
> 
> 
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 软件资源编译指南.pdf#page=12&selection=36,0,40,6&color=important|T23 软件资源编译指南, p.12]]
> > 3.1 T23 需要加载驱动

> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=26&selection=0,3,39,5&color=important|T23 BSP开发参考V1.1, p.26]]
...
### 1.编译驱动
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=26&selection=63,0,65,2&color=note|T23 BSP开发参考V1.1, p.26]]
> > ISP 驱动
> 
> 
...
### 2.驱动注册时提供的参数。
 > [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=26&selection=126,0,137,2&color=note|T23 BSP开发参考V1.1, p.26]]
...
驱动必须已经编译完成。
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=26&selection=293,0,298,2&color=note|T23 BSP开发参考V1.1, p.26]]
> > 6.1.2 Sensor 驱动
> 
> 

### 2..驱动注册时提供的参数。
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=27&selection=110,0,116,5&color=note|T23 BSP开发参考V1.1, p.27]]
...
### 3.图像效果文件
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=28&selection=36,0,39,2&color=note|T23 BSP开发参考V1.1, p.28]]
> > 6.1.4 图像效果文件
> 
> 
...
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=27&selection=342,0,346,6&color=note|T23 BSP开发参考V1.1, p.27]]
> > 6.1.3 Sensor 探测识别驱动
> 
> 
...
### 1.编译驱动
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=37&selection=297,0,297,4&color=note|T23 BSP开发参考V1.1, p.37]]
> > 内核配置
> 
> 

> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=38&selection=109,0,111,2&color=note|T23 BSP开发参考V1.1, p.38]]
> > Audio 驱动
> 
> 
...
> [!PDF|important] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=28&selection=104,0,110,2&color=important|T23 BSP开发参考V1.1, p.28]]
> > 6.1.5 Sample 的使用
> 
> 
...
### 1.应用程序编译
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/BSP/T23 BSP开发参考V1.1.pdf#page=16&selection=36,0,39,4&color=note|T23 BSP开发参考V1.1, p.16]]
> > 3.4 应用程序编译



### 2.VLC 浏览视频
> [!PDF|note] [[芯片开发学习/君正T23N芯片开发/sdk_资料库/君正T23N开发资料/T23 PIKE开发板使用指南.pdf#page=7&selection=109,0,113,4&color=note|T23 PIKE开发板使用指南, p.7]]
> > 2.2 VLC 浏览视频
> 
> 
