...
# 一、搭建 Camera 基础系统
> [!PDF|important] [[芯片开发学习/君正T23-ZN芯片开发/sdk资料库/君正T23-ZN开发资料/Ingenic_Zeratul_T23_开发指南.pdf#page=9&selection=18,0,24,4&color=important|Ingenic_Zeratul_T23_开发指南, p.9]]
> > 4. 搭建 Camera 基础系统
> 
> 
...
[[芯片开发学习/君正T23-ZN芯片开发/君正T23-ZN/2.系统分区编译]]
## 2.制作并进入 Normal u-boot（不行没config文件）
 > [!PDF|note] [[芯片开发学习/君正T23-ZN芯片开发/sdk资料库/君正T23-ZN开发资料/Ingenic_Zeratul_T23_开发指南.pdf#page=9&selection=38,0,40,13&color=note|Ingenic_Zeratul_T23_开发指南, p.9]]
...
## 3.调试阶段文件更新
> [!PDF|note] [[芯片开发学习/君正T23-ZN芯片开发/sdk资料库/君正T23-ZN开发资料/Ingenic_Zeratul_T23_开发指南.pdf#page=9&selection=220,0,220,13&color=note|Ingenic_Zeratul_T23_开发指南, p.9]]
> > 调试阶段文件更新与固件烧录
> 
> 
...
## 5、恢复与升级
> [!PDF|note] [[芯片开发学习/君正T23-ZN芯片开发/sdk资料库/君正T23-ZN开发资料/Ingenic_Zeratul_T23_开发指南.pdf#page=11&selection=20,0,20,5&color=note|Ingenic_Zeratul_T23_开发指南, p.11]]
> > 恢复与升级
> 
> 
...
# 二、快起环境搭建(可能没用到)
> [!PDF|important] [[芯片开发学习/君正T23-ZN芯片开发/sdk资料库/君正T23-ZN开发资料/Ingenic_Zeratul_T23快起环境搭建.pdf#page=5&selection=20,0,20,4&color=important|Ingenic_Zeratul_T23快起环境搭建, p.5]]
> > 环境搭建
> 
> 
## 1.
...
# 三、如何添加文件到系统中
[[芯片开发学习/君正T23-ZN芯片开发/君正T23-ZN/2.系统分区编译#6、 system 编译]]
